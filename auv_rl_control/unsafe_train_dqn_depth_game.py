...
# Algorithms
pro_policy = DDQNPolicy(action_map, n_states=3, n_actions=np.size(angles), n_hidden=32)
ant_policy = DDQNPolicy(action_map, n_states=3, n_actions=np.size(angles), n_hidden=32)
