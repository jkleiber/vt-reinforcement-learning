...
# Algorithms
dqn_policy = DDQNPolicy(action_map, n_states=3, n_actions=np.size(angles), n_hidden=16, lr=1e-3, prefix="base")
...
if __name__ == "__main__":
    ...
    with open("unsafe_train_ddqn_depth_results.pkl", "wb") as f:
